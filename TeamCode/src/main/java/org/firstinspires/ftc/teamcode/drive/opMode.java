...
public class opMode extends LinearOpMode {
    ...
    public static double  PrecisionDenominatorTranslational = 1, PrecisionDenominatorAngle = 0.8;
...
//            telemetry.addData("sec", droneAssembly.drone_launch.seconds());
            ...
            telemetry.addData("left back", r.leftBack.getCurrent(CurrentUnit.AMPS));
            telemetry.addData("right back", r.rightBack.getCurrent(CurrentUnit.AMPS));
            telemetry.addData("left front", r.leftFront.getCurrent(CurrentUnit.AMPS));
            telemetry.addData("right front", r.rightFront.getCurrent(CurrentUnit.AMPS));
